    ...
    return (
        <div className='container-support'>
            <div className="header-support">
                ...
                <p>Gracias por elegir POINTV. En caso de duda, sugerencia o algún problema en el sitio web , por favor comuníquese a la administración a través de los siguientes medios.</p>
            </div>
            <div className="header-support">
            ...
            <div className='line-whatsapp'>
                ...
                <div className="lines">
                    <a href="https://api.whatsapp.com/send/?phone=573136985899&text&type=phone_number&app_absent=0" target='_blank'>
                        <div className="line">
            ...
            <div className="footer-support">
                ...
                <img src={logo} alt="" />
                <p>© 2024 POINTV. Todos los derechos reservados.</p>
